...
const CATEGORIES = [
  ...
  },
  {
    title: 'Budget Ramp',
    slug: 'ramp',
    desc: 'Cheap green land ramp spells, basic land fetchers, and mana dorks under $1.50.',
    badge: 'Land Ramp',
    icon: Zap,
    color: 'from-amber-500/20 to-orange-500/10 border-amber-500/30',
  },
  {
    title: 'Budget Mana Rocks',
    slug: 'mana-rocks',
    desc: 'The best 2-drop artifact rocks, signets, talismans, and utility mana rocks under $1.50.',
    badge: 'Artifact Ramp',
    icon: Zap,
    color: 'from-amber-500/20 to-yellow-500/10 border-amber-500/30',
  },
  ...
  {
    title: 'Cards Under $2.00',
    slug: 'cards-under-2-dollars',
    desc: 'Mid-tier budget staples and tournament-power EDH cards under two dollars.',
    badge: 'Mid Budget',
    icon: TrendingDown,
    color: 'from-emerald-500/20 to-teal-500/10 border-emerald-500/30',
  },
  {
    title: 'Cards Under $5.00',
    slug: 'cards-under-5-dollars',
    desc: 'High-power format anchors, premium tutors, and game-winners under five dollars.',
    badge: 'Power Tier',
    icon: TrendingDown,
    color: 'from-amber-500/20 to-yellow-500/10 border-amber-500/30',
  },
